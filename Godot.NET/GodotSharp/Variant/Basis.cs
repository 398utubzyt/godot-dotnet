...
namespace Godot
{
    ...
    public struct Basis : IEquatable<Basis>
    {
        ...
        public readonly Vector3 Scale
        {
            get
            {
                Real detSign = Mathf.Sign(Determinant());
        ...
        {
            Real cofac00 = Row1[1] * Row2[2] - Row1[2] * Row2[1];
            Real cofac10 = Row1[2] * Row2[0] - Row1[0] * Row2[2];
            Real cofac20 = Row1[0] * Row2[1] - Row1[1] * Row2[0];
        ...
        {
            Real trace = Row0[0] + Row1[1] + Row2[2];

            if (trace > 0.0f)
            {
                Real s = Mathf.Sqrt(trace + 1.0f) * 2f;
                Real inv_s = 1f / s;
            ...
            {
                Real s = Mathf.Sqrt(Row0[0] - Row1[1] - Row2[2] + 1.0f) * 2f;
                Real inv_s = 1f / s;
                return new Quaternion(
                    s * 0.25f,
                    (Row0[1] + Row1[0]) * inv_s,
        ...
        public readonly Quaternion GetRotationQuaternion()
        {
            ...
            Real det = orthonormalizedBasis.Determinant();
            if (det < 0)
            {
        ...
        public readonly Basis Inverse()
        {
            ...
            Real det = Row0[0] * cofac00 + Row0[1] * cofac10 + Row0[2] * cofac20;
            ...
            Real cofac01 = Row0[2] * Row2[1] - Row0[1] * Row2[2];
            Real cofac02 = Row0[1] * Row1[2] - Row0[2] * Row1[1];
            Real cofac11 = Row0[0] * Row2[2] - Row0[2] * Row2[0];
            Real cofac12 = Row0[2] * Row1[0] - Row0[0] * Row1[2];
            Real cofac21 = Row0[1] * Row2[0] - Row0[0] * Row2[1];
            Real cofac22 = Row0[0] * Row1[1] - Row0[1] * Row1[0];
        ...
        internal readonly Basis Lerp(Basis to, Real weight)
        {
            Basis b = this;
        ...
        public readonly Basis Rotated(Vector3 axis, Real angle)
        {
        ...
        public readonly Basis Slerp(Basis target, Real weight)
        {
        ...
        public readonly Real Tdotx(Vector3 with)
        {
        ...
        /// <param name="with">A vector to calculate the dot product with.</param>
        /// <returns>The resulting dot product.</returns>
        public readonly Real Tdoty(Vector3 with)
        {
        ...
        /// <param name="with">A vector to calculate the dot product with.</param>
        /// <returns>The resulting dot product.</returns>
        public readonly Real Tdotz(Vector3 with)
        {
        ...
        {
            Real s = 2.0f / quaternion.LengthSquared();

            Real xs = quaternion.X * s;
            Real ys = quaternion.Y * s;
            Real zs = quaternion.Z * s;
            Real wx = quaternion.W * xs;
            Real wy = quaternion.W * ys;
            Real wz = quaternion.W * zs;
            Real xx = quaternion.X * xs;
            Real xy = quaternion.X * ys;
            Real xz = quaternion.X * zs;
            Real yy = quaternion.Y * ys;
            Real yz = quaternion.Y * zs;
            Real zz = quaternion.Z * zs;
        ...
        /// <param name="axis">The axis to rotate around. Must be normalized.</param>
        /// <param name="angle">The angle to rotate, in radians.</param>
        public Basis(Vector3 axis, Real angle)
        {
            ...
            Real xyzt = axis.X * axis.Y * t;
            Real zyxs = axis.Z * sin;
            Row0.Y = xyzt - zyxs;
            Row1.X = xyzt + zyxs;
        ...
        public Basis(Real xx, Real yx, Real zx, Real xy, Real yy, Real zy, Real xz, Real yz, Real zz)
        {
        ...
        {
            (Real sin, Real cos) = Mathf.SinCos(euler.X);
