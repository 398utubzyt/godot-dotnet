...
namespace Godot
{
    ...
    public struct Plane : IEquatable<Plane>
    {
        ...
        public readonly Real DistanceTo(Vector3 point)
        {
        ...
        public readonly bool HasPoint(Vector3 point, Real tolerance = Mathf.Epsilon)
        {
            Real dist = _normal.Dot(point) - _d;
        ...
        {
            Real denom = _normal.Cross(b._normal).Dot(c._normal);
        ...
        public readonly Vector3? IntersectsRay(Vector3 from, Vector3 dir)
        {
            ...
            Real dist = (_normal.Dot(from) - _d) / den;
        ...
        public readonly Vector3? IntersectsSegment(Vector3 begin, Vector3 end)
        {
            ...
            Real dist = (_normal.Dot(begin) - _d) / den;
        ...
        public Plane(Real a, Real b, Real c, Real d)
        {
        ...
        /// <param name="normal">The normal of the plane, must be a unit vector.</param>
        /// <param name="d">The plane's distance from the origin. This value is typically non-negative.</param>
        public Plane(Vector3 normal, Real d)
        {
            _normal = normal;
            _d = d;
        }
        ...
        /// approximately equal, by running <see cref="Mathf.IsEqualApprox(Real, Real)"/> on each component.
        /// </summary>
        /// <param name="other">The other plane to compare.</param>
