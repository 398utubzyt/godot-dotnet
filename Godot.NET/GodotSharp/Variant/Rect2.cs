...
namespace Godot
{
    ...
    public struct Rect2 : IEquatable<Rect2>
    {
        ...
        /// on all sides.
        /// </summary>
        /// <seealso cref="GrowIndividual(Real, Real, Real, Real)"/>
        /// <seealso cref="GrowSide(Side, Real)"/>
        /// <param name="by">The amount to grow by.</param>
        /// <returns>The grown <see cref="Rect2"/>.</returns>
        public readonly Rect2 Grow(Real by)
        {
            Rect2 g = this;
        ...
        /// <returns>The grown <see cref="Rect2"/>.</returns>
        public readonly Rect2 GrowIndividual(Real left, Real top, Real right, Real bottom)
        {
            Rect2 g = this;
        ...
        /// <param name="by">The amount to grow by.</param>
        /// <returns>The grown <see cref="Rect2"/>.</returns>
        public readonly Rect2 GrowSide(Side side, Real by)
        {
            Rect2 g = this;
        ...
        public Rect2(Vector2 position, Real width, Real height)
        {
            _position = position;
        ...
        /// <param name="size">The size.</param>
        public Rect2(Real x, Real y, Vector2 size)
        {
        ...
        /// <param name="width">The width.</param>
        /// <param name="height">The height.</param>
        public Rect2(Real x, Real y, Real width, Real height)
        {
            _position = new Vector2(x, y);
            _size = new Vector2(width, height);
        }
