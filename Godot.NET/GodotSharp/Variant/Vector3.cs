...
namespace Godot
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        /// </summary>
        public readonly void Deconstruct(out Real x, out Real y, out Real z)
        {
            x = X;
            y = Y;
            z = Z;
        ...
        public readonly Real AngleTo(Vector3 to)
        {
        ...
        public readonly Vector3 CubicInterpolate(Vector3 b, Vector3 preA, Vector3 postB, Real weight)
        {
            return new Vector3
            (
        ...
        /// <returns>The interpolated vector.</returns>
        public readonly Vector3 CubicInterpolateInTime(Vector3 b, Vector3 preA, Vector3 postB, Real weight, Real t, Real preAT, Real postBT)
        {
            return new Vector3
            (
        ...
        /// <returns>The interpolated vector.</returns>
        public readonly Vector3 BezierInterpolate(Vector3 control1, Vector3 control2, Vector3 end, Real t)
        {
            return new Vector3
            (
        ...
        public readonly Vector3 BezierDerivative(Vector3 control1, Vector3 control2, Vector3 end, Real t)
        {
            return new Vector3(
        ...
        public readonly Real DistanceSquaredTo(Vector3 to)
        {
        ...
        public readonly Real DistanceTo(Vector3 to)
        {
        ...
        public readonly Real Dot(Vector3 with)
        {
        ...
        public readonly Vector3 Lerp(Vector3 to, Real weight)
        {
            return new Vector3
            (
        ...
        public readonly Vector3 LimitLength(Real length = 1.0f)
        {
            Vector3 v = this;
            Real l = Length();
        ...
        public readonly Vector3 MoveToward(Vector3 to, Real delta)
        {
            Vector3 v = this;
            Vector3 vd = to - v;
            Real len = vd.Length();
        ...
        /// </returns>
        public readonly Vector3 PosMod(Real mod)
        {
            Vector3 v;
        ...
        public readonly Vector3 Rotated(Vector3 axis, Real angle)
        {
#if DEBUG
        ...
        public readonly Real SignedAngleTo(Vector3 to, Vector3 axis)
        {
            Vector3 crossTo = Cross(to);
            Real unsignedAngle = Mathf.Atan2(crossTo.Length(), Dot(to));
            Real sign = crossTo.Dot(axis);
        ...
        /// having zero length, this method behaves like <see cref="Lerp(Vector3, Real)"/>.
        /// </summary>
        /// <param name="to">The destination vector for interpolation.</param>
        /// <param name="weight">A value on the range of 0.0 to 1.0, representing the amount of interpolation.</param>
        /// <returns>The resulting vector of the interpolation.</returns>
        public readonly Vector3 Slerp(Vector3 to, Real weight)
        {
        ...
        public static Vector3 operator *(Vector3 vec, Real scale)
        {
            vec.X *= scale;
            vec.Y *= scale;
            vec.Z *= scale;
        ...
        /// <param name="vec">The vector to multiply.</param>
        /// <returns>The multiplied vector.</returns>
        public static Vector3 operator *(Real scale, Vector3 vec)
        {
            vec.X *= scale;
            vec.Y *= scale;
            vec.Z *= scale;
        ...
        public static Vector3 operator /(Vector3 vec, Real divisor)
        {
            vec.X /= divisor;
            vec.Y /= divisor;
            vec.Z /= divisor;
