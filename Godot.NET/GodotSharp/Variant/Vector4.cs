...
namespace Godot
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        /// </summary>
        public readonly void Deconstruct(out Real x, out Real y, out Real z, out Real w)
        {
            x = X;
            y = Y;
            z = Z;
        ...
        public readonly Vector4 CubicInterpolate(Vector4 b, Vector4 preA, Vector4 postB, Real weight)
        {
            return new Vector4
            (
        ...
        /// <returns>The interpolated vector.</returns>
        public readonly Vector4 CubicInterpolateInTime(Vector4 b, Vector4 preA, Vector4 postB, Real weight, Real t, Real preAT, Real postBT)
        {
            return new Vector4
            (
        ...
        public readonly Real DistanceSquaredTo(Vector4 to)
        {
        ...
        public readonly Real DistanceTo(Vector4 to)
        {
        ...
        public readonly Real Dot(Vector4 with)
        {
        ...
        public readonly Vector4 Lerp(Vector4 to, Real weight)
        {
            return new Vector4
            (
        ...
        /// </returns>
        public readonly Vector4 PosMod(Real mod)
        {
            return new Vector4(
                Mathf.PosMod(X, mod),
                Mathf.PosMod(Y, mod),
        ...
        public static Vector4 operator *(Vector4 vec, Real scale)
        {
            vec.X *= scale;
            vec.Y *= scale;
            vec.Z *= scale;
        ...
        /// <param name="vec">The vector to multiply.</param>
        /// <returns>The multiplied vector.</returns>
        public static Vector4 operator *(Real scale, Vector4 vec)
        {
            vec.X *= scale;
            vec.Y *= scale;
            vec.Z *= scale;
        ...
        public static Vector4 operator /(Vector4 vec, Real divisor)
        {
            vec.X /= divisor;
            vec.Y /= divisor;
            vec.Z /= divisor;
